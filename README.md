...
2. Download the `Glassmorphism_1_0_0_1.zip` file from the latest release
...
2. Select all files and folders **inside** the folder (not the folder itself):
   ...
   - `solution.xml`
   - `CanvasApps/`
3. Compress them into a `.zip` file (e.g. `Glassmorphism_1_0_0_1.zip`)
...
2. Find **GlassMorphism** in the list
